...
public class StoreDataInSQLite {
	...
	public static final String KEY_AVGSPLIT = "strAvgSplit";
	...
	public long createRow(String strDistance, String strTime, String strAvgSplit, String strDate) {
		Log.i(TAG, "Inserting record...");
		ContentValues initialValues = new ContentValues();
		initialValues.put(KEY_DISTANCE, strDistance);
		initialValues.put(KEY_TIME, strTime);
		initialValues.put(KEY_AVGSPLIT, strAvgSplit);
	...
	public Cursor fetchAllData() {
		...
		return mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_DISTANCE,
				KEY_TIME, KEY_AVGSPLIT, KEY_DATE }, null, null, null, null, null);
	}
	public Cursor fetchData(long empId) throws SQLException {
		...
		Cursor mCursor =
				...
				mDb.query(true, DATABASE_TABLE, new String[] { KEY_ROWID,
						KEY_DISTANCE, KEY_TIME, KEY_AVGSPLIT, KEY_DATE }, KEY_ROWID + "=" + empId, null,
						null, null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
	...
	public boolean updateHistory(int empId, String strDistance, String strTime, String strAvgSplit, String strDate) {
		ContentValues args = new ContentValues();
		args.put(KEY_DISTANCE, strDistance);
		args.put(KEY_TIME, strTime);
		args.put(KEY_AVGSPLIT, strAvgSplit);
