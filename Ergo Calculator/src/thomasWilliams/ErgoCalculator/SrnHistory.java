...
public class SrnHistory extends ListActivity {
	...
	private void generateListView() {
		...
		int columnIndex3 = 3; // KEY_AVGSPLIT
		...
		if (cursor.moveToFirst())
		{
			...
			{
				String strMonth = "Feb";
				String srtTimeBeforeFormat = cursor.getString(columnIndex2);
				FormatStringToTime formatTime = new FormatStringToTime(srtTimeBeforeFormat);
				String srtStringTimeInTimeFormat = formatTime.getStringInCorrectTimeFormat();

				String srtAvgSplitBeforeFormat = cursor.getString(columnIndex3);
				FormatStringToTime formatAvgSplit = new FormatStringToTime(srtAvgSplitBeforeFormat);
				String srtStringAvgSplitInTimeFormat = formatAvgSplit.getStringInCorrectTimeFormat();

				myString[i] = "Date/Time: " + cursor.getString(columnIndex4) + "\n\nDistance:  " + cursor.getString(columnIndex1)
						+ " meters\nTime:      " + srtStringTimeInTimeFormat + " mm:ss.0\nAvgSplit:  " + srtStringAvgSplitInTimeFormat + " mm:ss.0";
				cursor.moveToNext();
			}
		}
		cursor.close();
