...
public class ErgoCalculatorActivity extends TabActivity implements OnTabChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TabSpec2.setIndicator("Weight Adjust").setContent(new Intent(this, TabWeightAdjusted.class));
		TabSpec3.setIndicator("Predictions").setContent(new Intent(this, TabPredictions.class));
		TabSpec4.setIndicator("World Records").setContent(new Intent(this, TabWorldRecords.class));

		TabSpec1.setIndicator("Calculate", getResources().getDrawable(R.drawable.calculator));
		TabSpec2.setIndicator("Weight Adj", getResources().getDrawable(R.drawable.scales));
		TabSpec3.setIndicator("Predictions", getResources().getDrawable(R.drawable.trend));
		TabSpec4.setIndicator("Records", getResources().getDrawable(R.drawable.world));
